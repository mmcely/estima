...
class EditRessourceScreen extends StatefulWidget {
  const EditRessourceScreen({super.key});

  @override
  State<EditRessourceScreen> createState() => _EditRessourceScreenState();
}

class _EditRessourceScreenState extends State<EditRessourceScreen> {
